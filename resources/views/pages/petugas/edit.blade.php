...
@section('title', 'Ubah Daftar Calon Siswa Administrasi - MTI Priangan')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Ubah Daftar Calon Siswa Administrasi</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Beranda</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('daftar-calon-siswa.administrasi.index') }}">Daftar Calon
                                Siswa</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Ubah Daftar Calon Siswa Administrasi MTI Pariangan</h4>
                    <p class="card-title-desc">Ubah calon siswa MTI Pariangan</code>.
                    </p>

                    <form method="POST" action="{{ route('daftar-calon-siswa.administrasi.update', $student->id) }}">
                        @csrf
                        @method('PUT')
